...
*  Copyright(C) 2026 - MT
*
*  Calculates  the  definite integral for a function  fn(x)  using  Romberg
*  method. 
*
...
*
*  17 Jun 26   0.1   - Initial version - MT
* 
}
...
BEGIN
   ...
   REPEAT
      ...
      f := 1.0;
      FOR k := 1 TO i DO  { Find Richardson extrapolation R[i,k] = (4^k * R[i,k-1] - R[i-1,k-1]) / (4^k - 1) }
      BEGIN
         f := 4.0 * f;  { f = 4, 16, 64, ... }
